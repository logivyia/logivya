...
const errorKeyByCode: Record<string, string> = {
  ...
  MFA_RATE_LIMITED: "api.error.rateLimited",
  ...
  MFA_CONFIGURATION_ERROR: "api.error.configuration",
  AUTH_SESSION_CREATE_FAILED: "api.error.configuration",
  AUTH_INTERNAL_ERROR: "api.error.generic",
