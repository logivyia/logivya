...
export async function GET(request: Request) {
  try {
    ...
    const subscriptionStatus = serializeSubscription(
    ...
    const recoverableAccountWhere = {
      ...
      OR: [
        { lastError: null },
        { lastError: { notIn: ["WHATSAPP_LOGGED_OUT"] } },
      ],
    ...
    return mobileSuccess({
      ...
      trial: {
        ...
        remainingDays: subscriptionStatus.isTrial
      ...
      app: {
        minimumSupportedVersion:
          process.env.MOBILE_MIN_SUPPORTED_VERSION || "1.0.0",
      },
    });
  } catch (error) {
