...
export type SendGroupMessageInput = { accountId: string; groupExternalId: string; content: string; attachment?: WhatsAppOutboundAttachment; correlationId?: string; campaignId?: string; recipientId?: string; beforeTransport?: () => Promise<void> };
...
export type SendContactMessageInput = { accountId: string; contactExternalId: string; content: string; attachment?: WhatsAppOutboundAttachment; correlationId?: string; campaignId?: string; recipientId?: string; beforeTransport?: () => Promise<void> };
