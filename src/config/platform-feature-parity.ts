// Implementation coverage; store approval/distribution is tracked separately.
...
export const platformFeatureRegistry = [
  {
    ...
    status: "implemented",
    businessLogicOwner: "backend",
    platforms: { desktopWeb: "implemented", mobileWeb: "implemented", android: "implemented", ios: "implemented" },
  ...
  },
  {
    ...
    status: "partial",
    businessLogicOwner: "backend",
    platforms: { desktopWeb: "implemented", mobileWeb: "implemented", android: "partial", ios: "partial" },
