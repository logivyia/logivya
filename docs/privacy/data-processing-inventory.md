...
| Campaign/message delivery | Recipients; content, targets, delivery state, message keys | Customer and WhatsApp | PostgreSQL, Redis, Render worker | Processor candidate | Operational/history schedule requires review |
...
| Administrator operations | Users/companies; records needed for support/security/privacy | Platform admin | PostgreSQL audit trail | Controller | Restricted, reasoned and auditable |
