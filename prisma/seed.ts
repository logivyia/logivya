...
const plans = [
  ...
  { name: "Başlangıç", slug: "starter", description:"Küçük işletmeler ve bireysel kullanıcılar için.",monthlyPrice:280,yearlyPrice:3600,currency:"TRY",maxWhatsappAccounts:2,maxTeamUsers:2,maxGroups:2147483647,maxMessagesPerDay:2147483647,maxMessagesPerMonth:2147483647,groupMessagingEnabled:true,contactMessagingEnabled:false,deleteForEveryoneEnabled:true,advertisingEnabled:true,hasScheduledMessages:true,hasRecurringMessages:true,hasNoBranding:false },
