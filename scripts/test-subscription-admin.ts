...
const checks: Array<[string, string, string[]]> = [
  ...
  ["manual activation", "src/server/billing/manual-activation.ts", ["MANUALLY_CONFIRMED", "subscription.manual_activated"]],
  ...
  ["admin UI", "src/components/admin-subscriptions-page.tsx", ["Manuel", "FREE_PROMO", "CHANGE_PLAN"]],
