...
function SubscriptionFeatureScreen() {
  return <FeatureErrorBoundary feature="subscription"><SubscriptionScreen /></FeatureErrorBoundary>;
}

function TeamUsersFeatureScreen() {
  return <FeatureErrorBoundary feature="team-users"><TeamUsersScreen /></FeatureErrorBoundary>;
}
...
export function ProfileNavigator() {
  ...
  return (
    <ScreenBottomInsetContext.Provider value={false}>
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="Subscription" component={SubscriptionFeatureScreen} options={{ title: t("subscription") }} />
      ...
      <Stack.Screen name="TeamUsers" component={TeamUsersFeatureScreen} options={{ title: t("users") }} />
