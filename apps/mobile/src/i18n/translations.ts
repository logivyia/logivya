...
const baseTranslations = {
  tr: {
    ...
    fullName: "Ad Soyadı",
    role: "Rol",
    whatsappSendPaused: "WhatsApp kısıtlama sinyali nedeniyle gönderimler 24 saat durduruldu. Hesabınızı WhatsApp üzerinden kontrol edin; süre dolduktan sonra yalnızca başarısız hedefleri yeniden deneyin.",
  ...
  en: {
    ...
    fullName: "Full name",
    role: "Role",
    whatsappSendPaused: "Sends were stopped for 24 hours after a WhatsApp restriction signal. Check your account in WhatsApp; retry only failed recipients after the pause ends.",
