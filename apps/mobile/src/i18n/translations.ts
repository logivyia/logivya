...
const baseTranslations = {
  tr: {
    ...
    privacyDiagnosticsDescription: "Teknik sorunların incelenmesine yardımcı olan isteğe bağlı hata verilerini paylaşın.",
    ...
    companyDeletionPhrase: "LOGIVYA ŞİRKETİMİ SİL",
    userAccountScope: "Yalnızca kullanıcı hesabım",
    companyAccountScope: "Şirket hesabı ve ilişkili veriler",
    ...
    ,mfaLogoutEverywhere: "Her yerden cikis yap"
    ,mfaLogoutEverywhereConfirm: "Tum web ve mobil oturumlariniz kapatilacak. Devam edilsin mi?"
    ...
    ,verifyEmailTrialDescription: "7 gunluk deneme, ilk basarili WhatsApp baglantisi kuruldugu anda otomatik baslar."
  ...
  en: {
    ...
    privacyDiagnosticsDescription: "Share optional error data that helps investigate technical issues.",
    ...
    companyDeletionPhrase: "DELETE MY LOGIVYA COMPANY",
    userAccountScope: "My user account only",
    companyAccountScope: "Company account and associated data",
