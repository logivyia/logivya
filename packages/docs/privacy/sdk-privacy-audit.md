...
| Firebase Performance Monitoring | Android | App startup, network latency, screen rendering and device/app metadata; no message content | Disabled by diagnostics preference default | Confirm Firebase retention, Data Safety answers and production dashboard access |
